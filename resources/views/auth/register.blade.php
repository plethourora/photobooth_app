...
<style>
    ...
    /* ---------------------------------- */
    .login-wrapper {
        /* Warna Gradasi Animated (Sama dengan Login & Home) */
...
<div class="login-wrapper">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-7"> <div class="poselab-card">
                    <h1 class="poselab-title">Register</h1>
                    <p class="mb-4 text-white-50">Buat akun baru Anda untuk mulai berfoto</p>
                    ...
                    <form method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="name" class="form-control-custom" placeholder="Nama Lengkap" value="{{ old('name') }}" required>
                                @error('name') <small class="text-danger">{{ $message }}</small> @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-white">Email Address</label>
                                <input type="email" name="email" class="form-control-custom" placeholder="Email Anda" value="{{ old('email') }}" required>
                        ...
                        <div class="text-center mt-3">
                            <small class="text-white-50">Sudah punya akun? <a href="{{ url('/login') }}" class="text-tosca text-decoration-none fw-bold">Login disini</a></small>
                        </div>
                    </form>
                </div>
